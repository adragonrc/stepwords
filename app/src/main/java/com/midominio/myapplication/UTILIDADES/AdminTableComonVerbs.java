...
public class AdminTableComonVerbs {
    public static final String TABLE_NAME = "VerbosComunes";
    ...
    public static int Max = 453;
    public static String namePosPalabraMax = "spComVerbPosMax";
